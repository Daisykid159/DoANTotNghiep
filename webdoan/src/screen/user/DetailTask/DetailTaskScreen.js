                ...
                <div className={cx('col-md-12', 'mb-3')}>
                    ...
                    <div className={cx('task_content')}>
                        <div className={cx('col-md-6', 'd-flex', 'mb-2')}>
                            ...
                            <div className={cx('col-md-8')}>{detailTask.assign_organization_department_name}/ {detailTask.assign_user_name}</div>
                        </div>

                        <div className={cx('col-md-6', 'd-flex', 'mb-2')}>
                            <div className={cx('col-md-3', 'fw-bold')}>Người chủ trì:</div>
                            <div className={cx('col-md-8')}>{detailTask.target_organization_department_name}/ {detailTask.target_user_name}</div>
                        </div>
